...
SCB->VTOR  = 0x10000000 & 0x3FFFFF80;
  ...
  PINSEL_ConfigPin(PIN1_SWITCH_DETECT_PORT,PIN1_SWITCH_DETECT_PIN,0);
  GPIO_SetDir(PIN1_SWITCH_DETECT_PORT,(1 << PIN1_SWITCH_DETECT_PIN),0);
	PINSEL_SetPinMode (PIN1_SWITCH_DETECT_PORT, PIN1_SWITCH_DETECT_PIN, IOCON_MODE_PLAIN);

	Activate_ProtocolPin(PROTOCOL_KWP_RELAY, OFF_MODE);
	Activate_ProtocolPin(PROTOCOL_TYPE1_RELAY, OFF_MODE);
	Activate_ProtocolPin(PROTOCOL_CAN_RELAY, OFF_MODE);
	
	
	Activate_OBDPin(1, OFF_MODE);
	Activate_OBDPin(2, OFF_MODE);
	Activate_OBDPin(3, OFF_MODE);
	Activate_OBDPin(6, OFF_MODE);
	Activate_OBDPin(7, OFF_MODE);
	Activate_OBDPin(8, OFF_MODE);
	Activate_OBDPin(9, OFF_MODE);
	Activate_OBDPin(10, OFF_MODE);
	Activate_OBDPin(11, OFF_MODE);
	Activate_OBDPin(12, OFF_MODE);
	Activate_OBDPin(13, OFF_MODE);
	Activate_OBDPin(14, OFF_MODE);
	Activate_OBDPin(15, OFF_MODE);
	
	Activate_LEDPin(LED_FAULT,OFF_MODE);
