/**********************************************************************
* $Id: lpc177x_8x_mci.c 28 2014-01-27 14:45:13Z danielru $         lpc177x_8x_mci.c            2011-06-02
*//**
...
/************************************************************************//**
 * @brief        Turn on the MCI power by enabling the Power Register for MCI
 *
 * @param        None
 *
 * @return       None
 ****************************************************************************/
void MCI_PowerOn(void) 
{
    volatile uint32_t i;
